...
// =========================================================================
// FINAL FIX: Import from 'db/effects' to use the Effector wrappers, not the raw DB functions.
// =========================================================================
import {
  enqueueDownloadFx,
  getNextQueueItemFx,
...
export async function handleNewTask(user: UserInfo) {
  ...
  try {
    ...
    // =========================================================================
    // FINAL FIX: Call the Effector effect `enqueueDownloadFx` with the correct object payload.
    // =========================================================================
    await enqueueDownloadFx({ telegram_id, target_username });
