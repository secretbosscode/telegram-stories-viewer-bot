...
// Ensure this module patches console methods only once even if imported multiple times
declare global {
  // eslint-disable-next-line no-var
  var __setupLogsInitialized: boolean | undefined;
}

if (!global.__setupLogsInitialized) {
  global.__setupLogsInitialized = true;
